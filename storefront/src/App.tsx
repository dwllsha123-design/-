            ...
            <Route
              ...
              element={
                <ContentPage
                  title="من نحن"
                  body={[
                    'دار الأنوثة — Dar Al-Onotha متخصصة في الملابس النسائية واللانجري والأرواب والباروكات.',
                    'نخدم عميلاتنا من طرابلس — ليبيا، مع توصيل داخلي داخل طرابلس وخارجي لباقي المدن.',
              ...
              element={
                <ContentPage
                  ...
                  body={[
                    ...
                    'الأسعار بالدينار الليبي (LYD) وقابلة للتحديث حسب المخزون والعروض.',
                  ]}
                />
              }
            />
